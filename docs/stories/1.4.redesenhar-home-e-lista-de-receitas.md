...
3. Busca inline na App Bar: ao ativar, campo substitui o título e filtra resultados localmente (debounce 300–500 ms); limpar retorna ao título.
4. Estados: skeleton para carregamento; mensagem de erro com ação “Tentar de novo”; se Recentes vazio, ocultar seção OU exibir placeholder “Sem recentes” + CTA “Criar/Importar receita”.
...
### Testing
- Compose UI: verificação de snapping 1 por viewport (com PEEK), alternância lista↔grade, debounce de busca, placeholders de loading/erro, navegação para Detalhe.
